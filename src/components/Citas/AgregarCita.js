...
class AgregarCita extends Component {
  ...
  handlePicker = datetime => {
    this.setState({
      ...
      //chonseDate3: moment(datetime).format('YYYY-MM-DD'),
    });
  };
  ...
  fetchDataClinicas = async () => {
    ...
    // console.log('sucursales.clinicas', sucursales.clinicas);
    //console.log("sucursales.clinicas", sucursales.clinicas);
    // this.setState({ clinicas: sucursales.clinicas });
    // console.log('clinicas', this.state.clinicas);
   ...
   // .post("http://phplaravel-227278-1009310.cloudwaysapps.com/panama/api/crearcita",{
      ...
      .then(response => {
        ...
        if (response.data.success == true) {
          ...
          // this.props.oncita(response.data.data[0]);
          ...
          <ScrollView>
            ...
            <View>
              ...
              <TextInput
                ...
                //ref={input7 => { this.textInput = input7 }}
              />
              <DateTimePicker
...
export default connect(mapStateToProps, mapDispatchToProps)(AgregarCita);
